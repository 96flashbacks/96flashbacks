...
const MacroObject wmotr_seg7_macro_objs[] = {
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_open,               /*yaw*/   0, /*pos*/ -4456,   827,   191, /*behParam*/ 0x00),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_open,               /*yaw*/   0, /*pos*/  3712, -2740,  5200, /*behParam*/ 0x80),
