...
const MacroObject wf_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_yellow_coin,                 /*yaw*/   0, /*pos*/  3843,  1075, -2815),
    MACRO_OBJECT(/*preset*/ macro_yellow_coin,                 /*yaw*/   0, /*pos*/  3843,  1075,  -767),
    //MACRO_OBJECT(/*preset*/ macro_yellow_coin,                 /*yaw*/   0, /*pos*/  -250,  2650,  2970),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_open,               /*yaw*/   0, /*pos*/ -1844,  1026,  3893, /*behParam*/ 0x40),
    MACRO_OBJECT(/*preset*/ macro_yellow_coin,                 /*yaw*/   0, /*pos*/  1558,  922,  2329),
