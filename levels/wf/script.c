...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_07, /*pos*/   0,   3519, -2800, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    ...
    OBJECT(/*model*/ MODEL_WF_GIANT_POLE,     /*pos*/ -1213, 2560,  1850, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvGiantPole),
    RETURN(),
};
...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/ -2495, 2015,  -256, /*angle*/ 0, 0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/  0, 3750,  -2800, /*angle*/ 0, 0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/  -384, 3684,    6, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ bhvStar,                 /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    //OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/     0, 5900, 3819, /*angle*/ 0, 0, 0, /*behParam*/ 0x05000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS), //star seen in e3 b-roll
    RETURN(),
};
