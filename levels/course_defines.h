...
DEFINE_COURSE(COURSE_WF,   0x00020040)            // (2)  Whomp's Fortress
DEFINE_COURSE(COURSE_JRB,  0x22222240)            // (3)  Jolly Rodger's Bay
DEFINE_COURSE(COURSE_CCM,  0x00200240)            // (4)  Cool Cool Mountain
DEFINE_COURSE(COURSE_BBH,  0x22222240)            // (5)  Big Boo's Haunt
DEFINE_COURSE(COURSE_HMC,  0x22222240)            // (6)  Hazy Maze Cave
DEFINE_COURSE(COURSE_LLL,  0x21121240)            // (7)  Lethal Lava Land
DEFINE_COURSE(COURSE_SSL,  0x22222240)            // (8)  Shifting Sand Land
DEFINE_COURSE(COURSE_DDD,  0x22222240)            // (9)  Dire Dire Docks
DEFINE_COURSE(COURSE_SL,   0x02022040)            // (10) Snowman's Land
DEFINE_COURSE(COURSE_WDW,  0x12022240)            // (11) Wet Dry World
DEFINE_COURSE(COURSE_TTM,  0x00000040)            // (12) Tall Tall Mountain
DEFINE_COURSE(COURSE_THI,  0x11110140)            // (13) Tiny Huge Island
