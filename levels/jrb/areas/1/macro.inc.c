...
const MacroObject jrb_seg7_area_1_macro_objs[] = {
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,             /*yaw*/ 250, /*pos*/ -6325,  1126,  1730, /*behParam*/ DIALOG_060), //funny sign
    ...
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_open,               /*yaw*/   0, /*pos*/ -5905,  1175,  2136, /*behParam*/ 0x00),
