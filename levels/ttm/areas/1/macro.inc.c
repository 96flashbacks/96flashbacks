...
const MacroObject ttm_seg7_area_1_macro_objs[] = {
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_cannon_open,               /*yaw*/  45, /*pos*/  5035, -3994, -3445, /*behParam*/ 0xC0),
   ...
   //MACRO_OBJECT(/*preset*/ macro_red_coin,                    /*yaw*/   0, /*pos*/ -1500,  -800, -2750),
    MACRO_OBJECT_WITH_BEH_PARAM(/*preset*/ macro_wooden_signpost,             /*yaw*/  90, /*pos*/ -1126, -2593, -4400, /*behParam*/ DIALOG_091),
