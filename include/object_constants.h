...
/* Koopa */
    ...
    #define KOOPA_THE_QUICK_ACT_WAIT_BEFORE_RACE 7
    #define KOOPA_THE_QUICK_ACT_UNUSED1 8
    #define KOOPA_THE_QUICK_ACT_SHOW_INIT_TEXT 9
    #define KOOPA_THE_QUICK_ACT_RACE 10
