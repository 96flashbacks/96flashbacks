...
const BehaviorScript bhvGiantPole[] = {
    ...
    SET_HITBOX(/*Radius*/ 65, /*Height*/ 2100),
    SET_HOME(),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvPoleGrabbing[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oInteractType, INTERACT_POLE),
    SET_HITBOX(/*Radius*/ 65, /*Height*/ 1500),
...
const BehaviorScript bhvFlamethrowerFlame[] = { //change the drawing distance of the flamethrower flame
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_FLAME),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 25, /*Downwards offset*/ 25),
...
/* formerly named 'bhvStarKeyCollectionPuffSpawner' */
const BehaviorScript e_V_stardust[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    BILLBOARD(),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    //SET_INT(oAnimState, -1),
    BEGIN_LOOP(),
        CALL_NATIVE(s_V_stardust),
        ANIMATE_TEXTURE(oAnimState, 2),
    END_LOOP(),
};
...
const BehaviorScript bhvHiddenStarTrigger[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_HITBOX(/*Radius*/ 30, /*Height*/ 100),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
