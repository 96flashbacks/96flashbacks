COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       _("BIG BOB-OMB ON THE SUMMIT")     , _("SHOOT TO THE ISLAND IN THE SKY") , _("FOOTRACE WITH KOOPA THE QUICK"),
       _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE")      , _("UNUSED"))
...
COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S FORTRESS"),
       ...
       _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL")           , _("UNUSED"))
...
COURSE_ACTS(COURSE_JRB, _(" 3 JOLLY ROGER BAY"),
       ...
       _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM")        , _("UNUSED"))

COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL MOUNTAIN"),
       _("SLIP SLIDIN' AWAY")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL WORK")          , _("UNUSED"))
...
COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S HAUNT"),
       ...
       _("BIG BOO'S BALCONY")             , _("EYE TO EYE IN THE SECRET ROOM") , _("UNUSED"))

COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       _("SWIMMING BEAST IN THE CAVERN")  , _("METAL-HEAD MARIO CAN MOVE!")    , _("A-MAZE-ING EMERGENCY EXIT"),
       _("NAVIGATING THE TOXIC MAZE")     , _("WATCH FOR ROLLING ROCKS")     , _("UNUSED"))

COURSE_ACTS(COURSE_LLL, _(" 7 LETHAL LAVA LAND"),
       _("BOIL THE BIG BULLY")            , _("BULLY THE BULLIES")             , _("RED-HOT LOG ROLLING"),
       _("HOT-FOOT-IT INTO THE VOLCANO")  , _("ELEVATOR TOUR IN THE VOLCANO")  , _("UNUSED"))

COURSE_ACTS(COURSE_SSL, _(" 8 SHIFTING SAND LAND"),
       _("IN THE TALONS OF THE BIG BIRD") , _("IN THE SQUAREY MAZE")           , _("INSIDE THE ANCIENT PYRAMID"),
       _("STAND TALL ON THE FOUR PILLARS"), _("PYRAMID PUZZLE")                , _("UNUSED"))

COURSE_ACTS(COURSE_DDD, _(" 9 DIRE, DIRE DOCKS"),
       _("BOARD BOWSER'S SUB")            , _("CHESTS IN THE CURRENT")         , _("THROUGH THE JET STREAM"),
       _("THE MANTA RAY'S REWARD")        , _("COLLECT THE CAPS")              , _("UNUSED"))

COURSE_ACTS(COURSE_SL, _("10 SNOWMAN'S LAND"),
       _("SNOWMAN'S BIG HEAD")            , _("CHILL WITH THE BULLY")          , _("IN THE DEEP FREEZE"),
       _("WHIRL FROM THE FREEZING POND")  , _("INTO THE IGLOO")                , _("UNUSED"))

COURSE_ACTS(COURSE_WDW, _("11 WET-DRY WORLD"),
       _("SECRETS IN THE SHALLOWS & SKY")         , _("TOP O' THE TOWN")       , _("EXPRESS ELEVATORS-HURRY UP!"),
       _("IN THE FLOODED TOWN")        , _("QUICK RACE THROUGH DOWNTOWN")      , _("UNUSED"))

COURSE_ACTS(COURSE_TTM, _("12 TALL, TALL MOUNTAIN"),
       _("SCALE THE MOUNTAIN")            , _("MYSTERY OF THE MONKEY CAGE")    , _("MYSTERIOUS MOUNTAINSIDE"),
       _("BREATHTAKING VIEW FROM BRIDGE") , _("BLAST TO THE LONELY MUSHROOM") , _("UNUSED"))

COURSE_ACTS(COURSE_THI, _("13 TINY-HUGE ISLAND"),
       _("PLUCK THE PIRANHA FLOWER")      , _("THE TIP TOP OF THE HUGE ISLAND"), _("THE MINIATURE ISLE"),
       _("LONELY, LITTLE FLOATING ISLAND")       , _("IN THE SMALL HOLE")      , _("UNUSED"))

COURSE_ACTS(COURSE_TTC, _("14 TICK TOCK CLOCK"),
       _("ROLL INTO THE CAGE")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
       _("KING OF THE CLOCK")           , _("TIMED JUMPS ON MOVING BARS")    , _("UNUSED"))

COURSE_ACTS(COURSE_RR, _("15 RAINBOW RIDE"),
       _("UNUSED")  , _("UNUSED")      , _("UNUSED"),
       _("UNUSED")  , _("UNUSED")      , _("UNUSED"))
