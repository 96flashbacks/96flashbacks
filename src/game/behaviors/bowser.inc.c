...
void bowser_spawn_grand_star_key(void) {
    ...
    gSecondCameraFocus = spawn_object_relative(0, 0, 45.0f, 300.0f, o, MODEL_BOWSER_KEY, bhvBowserKey);
    gSecondCameraFocus->oAngleVelYaw = o->oAngleVelYaw;
    gSecondCameraFocus = spawn_object(o, MODEL_NONE, bhvUnused05A8);
}
