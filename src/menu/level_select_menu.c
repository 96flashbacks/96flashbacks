...
s16 level_select_input_loop(void) {
    ...
    // these two dont mean anything i just added them because they're pretty cool
    /* TO-DO: give these actual meaning */
    print_text(200, 116, "CODE 132K");
    print_text(200, 100, "ULIB 14K");
