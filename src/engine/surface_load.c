...
#define SURFACE_POOL_SIZE 2320      // JUST enough to fit the castle inside. Phew!
#define SURFACE_NODE_POOL_SIZE 7300 // 7300! - - - - - iprogram fuck you this makes no sense -crustman
...
void alloc_surface_pools(void) {
    ...
    sSurfaceNodePool =
        main_pool_alloc(SURFACE_NODE_POOL_SIZE * sizeof(struct SurfaceNode), MEMORY_POOL_LEFT);
